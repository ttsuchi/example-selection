'''
Compares the effect of dictionary learning among different sampling policies.
...
class RandomDictionaries:
    def __init__(self):
        self.do_plot = True
        self.generator = data.synthetic_random.SyntheticRandom(128, 64, 1, 1, .1)
        self.P = 128
        self.K = 64
